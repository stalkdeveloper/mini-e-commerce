...
<html>
   ...
   <body>
      <div class="hero_area">
         ...
         <section class="slider_section ">
            <div class="slider_bg_box">
               <img src="{{asset('web/images/slider-bg.jpg')}}" alt="">
            </div>
         ...
         <div class="container">
            <div class="box">
               <div class="arrival_bg_box">
                  <img src="{{asset('web/images/arrival-bg.png')}}" alt="">
               </div>
               <div class="row">
      ...
      <!-- subscribe section -->
      {{-- @include('user.include.home-subscribe') --}}
      <!-- end subscribe section -->
      <!-- client section -->
   
      <!-- end client section -->
      <!-- footer start -->
      @include('user.include.home-footer')
      <!-- footer end -->
      <div class="cpy_">
         <p class="mx-auto">© 2021 All Rights Reserved By <a href="/">Stalk Developer</a><br>
